...
internal static class ApplicationFeatureContractTests
{
    ...
    [TestCase("TEST-22D", "Pi Harbor 主品牌、副标题、图标与 1.3.0 版本进入窗口和程序集")]
    public static void ApplicationIdentityIsVersionedAndBranded()
    {
        ...
        AssertEx.Equal("1.3.0", values["Version"], "包版本必须为 1.3.0");
        AssertEx.Equal("1.3.0.0", values["FileVersion"], "文件版本必须为 1.3.0.0");
        ...
        AssertEx.Equal("1.3.0", MainViewModel.ApplicationVersion, "界面版本必须取自应用程序集");
