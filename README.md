...
**软件版本：1.3.1 · 已验证 Pi：0.84.3 · Windows 10/11 x64**
...
已提供 Windows CI 和版本标签发布工作流。推送与项目版本一致的 `v1.3.1` 标签后，自动测试、打包并创建带 **安装 EXE、便携 ZIP、SHA256SUMS** 的 Release 草稿；维护者检查后点击 Publish release，用户即可下载。
...
后续优先完善跨重启草稿、历史图片按需预览、模型能力提示和扩展交互表单，再推进会话搜索、管理及安装包代码签名。实现记录见 [输入体验与产品完善](docs/260907输入体验与产品完善记录.md)、[开源发布准备与验收](docs/260907开源发布准备记录.md)。
